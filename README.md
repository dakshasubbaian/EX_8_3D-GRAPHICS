...
Registration Number : 212223230036
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        glView.setRenderer(new com.example.experiment8.MyGLRenderer(this));
...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    private com.example.experiment8.Pyramid pyramid;
    private com.example.experiment8.Cube cube;
    ...
    public MyGLRenderer(Context context) {
        pyramid = new com.example.experiment8.Pyramid();
        cube = new com.example.experiment8.Cube();
    }
    @Override
...
![328199808-dc95f6bf-df09-4986-b53a-055f6a2fd1b9](https://github.com/dakshasubbaian/EX_8_3D-GRAPHICS/assets/112880924/cf5667a1-0f13-4775-8076-ff1a0005595c)
